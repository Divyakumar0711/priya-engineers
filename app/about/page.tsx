  ...
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
    ...
    <div className="w-full md:w-1/2">
      ...
      <p className="text-gray-700 text-lg leading-relaxed mb-4">
        Gamma Gears is a leader in precision gear manufacturing, known for its advanced engineering solutions and commitment to excellence. With decades of experience, we cater to a global clientele across multiple industrial sectors.
      </p>
      <p className="text-gray-700 text-lg leading-relaxed mb-4">
        Our foundation is built on quality craftsmanship, cutting-edge technology, and a team of professionals who strive to exceed expectations. Every product we deliver reflects our dedication to reliability and innovation.
      </p>
      <p className="text-gray-700 text-lg leading-relaxed">
        At Gamma Gears, we believe in building long-term partnerships by delivering performance-driven products and exceptional service that adds value to every customer we serve.
      </p>
    </div>
  </div>
</section>
      ...
      <section className="bg-gray-100 py-20 px-4">
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="hidden md:block absolute top-0 left-1/2 transform -translate-x-1/2 h-full w-1 bg-red-500" />
      ...
      <section className="bg-white py-20 px-6">
        <div className="max-w-4xl mx-auto space-y-16">
          {/* Our Quality */}
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-red-600 mb-6 tracking-[0.1em]">
              Our Quality: 
            </h2>
